...
const defaultCategories = [
  { id: "fixed", name: "Fixo", icon: "🏠", type: "expense", budget: 600 },
  { id: "reserve", name: "Reserva", icon: "🏦", type: "reserve", budget: 315 },
  { id: "meds", name: "Medicamentos", icon: "💊", type: "expense", budget: 200 },
  { id: "leisure", name: "Lazer", icon: "🎮", type: "expense", budget: 200 },
  { id: "phone", name: "Celular", icon: "📱", type: "expense", budget: 35 }
];
...
function getMonth(key = state.currentMonth) {
  if (!state.months[key]) {
    state.months[key] = {
      salaryReceived: state.settings.plannedSalary,
      expenses: [],
